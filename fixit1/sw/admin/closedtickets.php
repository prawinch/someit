    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                            <img alt="image" class="img-circle"
                                 src="../../profileimg/admin/<?php echo !empty($log_row['profilepic']) ? $log_row['profilepic'] : 'deafult.png'; ?>?rd=<?php echo rand(); ?>"
                                 height="100px" width="100px"/>
                             </span>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong
                                            class="font-bold"><?php echo $log_name; ?></strong>
                ...
                <li>
                    <a href="#"><i class="fa fa-users"></i> <span class="nav-label">FS Administration</span><span
                                class="fa arrow"></a>
                    <ul class="nav nav-second-level collapse">
                ...
                <li>
                    <a href="#"><i class="fa fa-file-o"></i> <span class="nav-label">Fakturering</span><span
                                class="fa arrow"></a>
                    <ul class="nav nav-second-level collapse">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                            <i class="fa fa-bell"></i> <span
                                    class="label label-primary"><?php echo $alert_num_rows; ?></span>
                        </a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover dataTables-example">
                                    ...
                                    <tr>
                                        ...
                                        <th>Öppnat När</th>
                                        <th>Status</th>
                                        <th style="width: 50px;">Redigera</th>
                                    </tr>
                                    </thead>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="DeleteLabel">Borttagna</h4>
            </div>
            <form id="deleteformdata">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="comment" minlength=10 id="message-text"
                                  required=""></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Avsluta</button>
...
if (isset($_GET['ticketdelete']) AND isset($_GET['ticket_id'])) {
    ...
    $message .= 'Din ärende har tagits bort av admin!<br><br> Din unika ärende-ID är ' . $ticket_id . '<br><br>';
    $message .= 'Telefonnummer som är registread med denna ärende är ' . $ini_phone . '<br><br>';
    $message .= 'Se status på ditt ärende <a href="' . $url . '/track.php?ticket_id=' . $ticket_id . '&phone=' . $ini_phone . '">' . $url . '/track.php?ticket_id=' . $ticket_id . '&phone=' . $ini_phone . '</a><br><br>';
    $message .= 'Regards,<br>Fixit<br><br>För frågor, vänligen kontakta oss på +46-9999999<br></body></html>';
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="Reopen">Återöppna</h4>
            </div>
...
if (isset($_POST['ticketreopen']) AND isset($_POST['ticket_id'])) {
    ...
    $message .= '<h4>Hi ' . $ini_name . '!</h4></br>';
    $message .= 'Admin har återöppnat ditt ärende - ' . $ticket_id . '<br><br>';
    $message .= 'Telefonnummer som är registread med denna ärende är ' . $ini_phone . '<br><br>';
    $message .= 'Spåra ditt ärende <a href="' . $url . '/track.php?ticket_id=' . $ticket_id . '&phone=' . $ini_phone . '">' . $url . '/track.php?ticket_id=' . $ticket_id . '&phone=' . $ini_phone . '</a><br><br>';
    $message .= 'Regards,<br>Fixit<br><br>För frågor, vänligen kontakta oss på +46-9999999<br></body></html>';
