            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Lägg Till Tjänst</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Lägg Till TJänster</h5>                        
                    </div>

                    <div class="ibox-content">
                    <form class="form-horizontal" action="" method="POST" enctype = "multipart/form-data">
                                <div class="form-group"><label class="col-lg-3 control-label">Läge</label>
                                    <div class="col-lg-4"><input type="text" name="service" value="" class="form-control" required>
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-lg-3 control-label">Fel</label>
                                    <div class="col-lg-4"><input type="text" name="sub_service" value="" class="form-control" required="">
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-lg-3 control-label">Pris</label>
                                    <div class="col-lg-4"><input type="text" name="price" value="" class="form-control" required="">
                                    </div>
                                </div>
                                
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-3">
                                        <button class="btn btn-white" type="reset" onclick="javascript:window.location='services.php';">Avbryt</button>
                                        <button class="btn btn-primary" name="add_service" type="submit">Spara</button>
                                    </div>
                                </div>
                            </form>                        
...
if(isset($_POST['add_service'])){        
        ...
        $service_res=mysqli_query($conn,"SELECT * FROM `services` WHERE `service`='$service' AND `sub_service`='$sub_service'");
        $service_num_rows=mysqli_num_rows($service_res);
        if($service_num_rows==0){
            $max_res=mysqli_query($conn,"SELECT MAX(`service_id`) AS max_id FROM `services` WHERE 1");
            $max_row=mysqli_fetch_array($max_res);
            $max_value=$max_row['max_id']+1;
            mysqli_query($conn,"INSERT INTO `services`(`service_id`, `service`, `sub_service`, `price`) VALUES ('$max_value','$service','$sub_service','$price')");
