...
<head>
    ...
    <link href="../../global/css/plugins/dataTables/datatables.min.css" rel="stylesheet">
        <!--X-editable-->
    <link href="../../global/x-editable/bootstrap-editable.css" rel="stylesheet"/>    
</head>
...
<body>
    <div id="wrapper">
                    ...
                    <li class="nav-header">
                        <div class="dropdown profile-element"> <span>
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                ...
                                <li class="divider"></li>
                                <li><a href="logout.php">LOGGGA UT</a></li>
                            </ul>
                        </div>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title" style="padding-bottom: 40px;">
                        <h5>Tjänster</h5><a href="serviceadd.php" class="btn btn-primary pull-right">Lägg till
                            tjänster</a>
                    </div>
            ...
            while($services_row = mysqli_fetch_array($services_res)){
              echo "<tr>
              <td>".$services_row['service_id']."</td>
              <td>".$services_row['service']."</td>
              <td>".$services_row['sub_service']."</td>
              <td><a href=\"#\" class=\"username\" id=\"username\" data-type=\"text\" data-pk=".$services_row['service_id']." data-url=\"serviceupdate.php\" data-title=\"Price\">".$services_row['price']."</a>
              </td>
              </tr>";
            }
            ?>
    ...
    <script src="../../global/x-editable/bootstrap-editable.min.js"></script>
