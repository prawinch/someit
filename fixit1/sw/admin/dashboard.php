                        ...
                        <div class="col-lg-4">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Daglig Statistik</h5>           
                                </div>
                                <div class="ibox-content">
                                    <ul class="list-group clear-list m-t">
                                        <li class="list-group-item fist-item"><span class="label label-success"><?php echo $statsopentod_row; ?></span> Öppna Ärenden</li>
                                        <li class="list-group-item"><span class="label label-info"><?php echo $statsclosetod_row; ?></span> Stängda Ärenden</li>
                                    </ul>
                                </div>
                            </div>
                        </div> 
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                <table class="table table-bordered">
                                    <thead>
                                    <tr><th>Ärende ID</th>
                                    <th class="text-right">Faktura ID</th>
