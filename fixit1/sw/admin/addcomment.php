...
if(isset($_POST['comment']) AND isset($_POST['postcomment'])){
  ...
  //phpmailer starts here
          ...
          $message .= 'Admin har kommentart på ditt ärende '.$ticket_id.'<br><br>';
          ...
          $message .= 'Med vänlig hälsning,<br>Fixit<br><br>För frågor, vänligen kontakta oss på +46-9999999<br></body></html>';
