    ...
    <div id="wrapper">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
          ...
          $startrow = (int)$_GET['startrow'];
            ...
            $result=mysqli_query($conn,"SELECT * FROM `vendors` WHERE `vendor_status`='Enabled'");
            while($row = mysqli_fetch_array($result)){
              ...
              <td>             
              <a class='btn btn-warning btn-circle btn-outline' data-toggle='modal' href='vendorlist.php?vendor_name=$vendor_name&disable=true'><i class='fa fa-ban'></i></a>
...
<?php
if (isset($_GET[ 'vendor_name']) AND isset($_GET[ 'disable'])){
