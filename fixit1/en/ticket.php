            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3 rotateInUpLeft" data-wow-duration="1.5s" data-wow-offset="10" data-wow-delay="0.5s">                        
                        <h2>Create New Ticket</h2>     <em>
                    Here you can create a new service request, please fill all the required details
                </em>                   
                    </div>
                </div>
            </div>
...
<div id="contact">
    <div class="container">
        ...
        </div><br><button type="submit" class="btn btn-success btn-lg" name="create">Create Request</button>
    </form>
	</div>
</div>
<?php
