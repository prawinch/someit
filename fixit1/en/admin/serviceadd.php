                    ...
                    <form class="form-horizontal" action="" method="POST" enctype = "multipart/form-data">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-3">
                                        <button class="btn btn-white" type="reset" onclick="javascript:window.location='services.php';">Cancel</button>
                                        <button class="btn btn-primary" name="add_service" type="submit">Save changes</button>
                                    </div>
                                </div>
                            </form>                        
