                ...
                <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                ...
                                <i class="fa fa-hand-o-right"></i> Assign to Vendor <span class="caret"></span></button>
                                <ul class="dropdown-menu">
                                    <?php
                                    $vendor_res=mysqli_query($conn,"SELECT DISTINCT `vendor_name` FROM `vendors` WHERE 1");
                                    while($vendor_row=mysqli_fetch_array($vendor_res)){
                                        echo '<li><a href="vendorassign.php?ticket_id='.$ticket_id.'&vendor_name='.$vendor_row['vendor_name'].'">'.$vendor_row['vendor_name'].'</a></li>';
                                    }                                    
                                    ?>
                                </ul>
                                </div>
                        ...
                        <div class="ibox-content">
                            <form class="form-horizontal" action="ticketedit.php" method="POST" enctype = "multipart/form-data">
                                ...
                                <div class="form-group"><label class="col-lg-3 control-label">Phone Number</label>
                                    <div class="col-lg-8">
   ...
   //File upload ends here
    ...
    $his_time = date("Y-m-d h:i:s");
        mysqli_query($conn, "INSERT INTO `history`(`ticket_id`, `time`, `comments`) VALUES ('$ticket_id','$his_time','Ticket details updated by Admin - $email')");
          ...
          $message .= 'Your Ticket has been updated by admin!<br><br> Your unique tracking code is '.$ticket_id.'<br><br>';
